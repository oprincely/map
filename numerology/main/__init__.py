...
from numerology.hello import contains_y,jeff, life_number,your_personal,real,hearts_d,image_num,bddict,year_num,lesson,debt
from numerology.hello import check_karma,peak,digit_sum,b_t_ms
...
def profile():
    ...
    return render_template('profile.html',msg=msg,year_now=year_now)  #return redirect(url_for('auth.login'))
