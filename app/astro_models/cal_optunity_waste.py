...
def main_optunity_waste(btd,btm,bty,transit_day,transit_month,transit_year,asc,mc,prog_moon):
    ...
    def calculate_midpts():
        ...
        def call_midpts(w,w1,w2,w3): #a = transit or arc or progressed
    ...
    #rip_transit_movemont(naspect, conj, transit) #b=naspect[n],p=coj,o=transit,x='squa',n=
    
    def do_calculate_for_natal():
        to_natals = []
        to_natals_clean = []
        
        to_natals.append(rip_transit_movemont(sextile))
        to_natals.append(rip_transit_movemont(trine))
