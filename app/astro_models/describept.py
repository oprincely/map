...
################################################################
#Sun and Venus
"sun_to_natven":"""Romance; love relationship; illumination of one's sense of
...
"nep_sun/ven":"""Dreaminess about love potential; overindulgences of all kinds
...
"mc_sun/ven":"""sun/ven":"""The love-union; marriage; feeling of fulfillment.""",
...
"mc_sun/mars":"""Success; loving one's work; efficiency; ready to fight for one's
principles.""",
...
"merc_sun/jup":"""Efficient and successful thinking; good news; writing,""",
...
"mars_sun/jup":"""Successful application ofwill-power; zeal; enthusiasm that
"catches on."""",
...
"sun_to_natlunarnod":"""Experiences shared with others become important; the
public..""",
"lunarnod_to_natsun":"""New contacts come into the life..""",
"moon_sun/lunarnod":"""Feelings shared with others; the relationship dynamics ofwife
and husband are highlighted..""",
"merc_sun/lunarnod":"""Communications with others; business contacts; news;
commentary..""",
"ven_sun/lunarnod":"""Lovely associations; the arts; beginning of a romantic
relationship..""",
"mars_sun/lunarnod":"""Vigorous drives with others to gain personal importance..""",
"jup_sun/lunarnod":"""Public recognition; associations with the wealthy or
international; positive legal involvements; good fortune..""",
"sat_sun/lunarnod":"""Reserve in relationships; maturation; patience with others..""",
"ura_sun/lunarnod":"""Attraction to unusual individuals; upsets through intensity; the
drive for popularity..""",
"nep_sun/lunarnod":"""Feeling that relationships are threatening or bothersome; feeling
let down by others..""",
"plu_sun/lunarnod":"""Being persuasive; ordering and controlling others; exerting
influence; public prominence..""",
"asc_sun/lunarnod":"""Making personal contacts..""",
"mc_sun/lunarnod":"""Becoming prominent through associations.""",
...
"jup_moon/nep":"""Big plans; luck and success; rich emotionalism.""",
...
"moon_to_natlunarnod":"""Association with others, usually emotionally based.""",
"lunarnod_to_natlmoon":"""Contacts with others brings assistance and comfort.""",
Harmony in relationships.""",
"sun_moon/lunarnod":"""Thinking about interpersonal reactions; getting along with
others; building cooperation.""",
"merc_moon/lunarnod":"""Affectionate attachments with others; contacts with artistic
people or cultural events.""",
"ven_moon/lunarnod":"""Energetic associations and teamwork.""",
"mars_moon/lunarnod":"""Confidence; good luck through interaction with others.""",
"jup_moon/lunarnod":"""Working hard with others; sometimes having then to "go it
alone."""",
"sat_moon/lunarnod":""Meeting exceptional people or experiencing unusual events with
or through others; sudden new attachments.""",
"ura_moon/plu":"""The potential undermining of relationships or contacts with
others; sentimentality.""",
"nep_moon/lunarnod":""Powerful forces affect interpersonal relationships; the sense
of fated attraction.""",
"asc_moon/lunarnod":""The importance of interpersonal relationships is brought
forward.""",
"mc_moon/lunarnod":""Ego-involvement intensified in emotional relationship.""",

#####################################################################################

#Moon and Ascendant 444
"moon_to_natnasc":"""AS Focus on personal needs and relationships to fulfill them.""",
...
"mars_merc/ven":"""Alerting the passions; making strong, emotional statements;
creativity.""",
"jup_merc/ven":"""Expansive idealization; perhaps religiousness; aesthetics;
...
effectively.""",
"sat_merc/jup":"""Sober decisions; rational thought; withdrawing from disputes to
...
"nep_merc/jup":"""Inspiration; beguiling fantasy; magnetism; losing the focus of an
...
"asc_merc/jup":"""Acceptance of one's well-organized thinking; successful
teamwork.""",
...
"merc_to_natlunarnod":"""Exchanging ideas with others.""",
"lunarnod_to_natmerc":"""Meeting others to exchange ideas.""",
"sun_merc/lunarnod":"""Putting together a philosophy of life.""",
"moon_merc/lunarnod":""" Sharing emotional thoughts with others.""",
"ven_merc/lunarnod":"""Socialization; sharing affection with others; kindness.""",
"mars_merc/lunarnod":"""Making things happen in group sharing.""",
"jup_merc/lunarnod":"""Teaching; communication; philosophizing; partnership.""",
"sat_merc/lunarnod":"""Reticence about sharing one's point ofview with others; perhaps
too much self-control or modesty.""",
"ura_merc/lunarnod":"""Stimulating ideas shared; sudden business contacts; selfaggrandizement
that disturbs relationships.""",
"nep_merc/lunarnod":"""Confusion about how to fit into the group.""",
"plu_merc/lunarnod":"""The thrust of intelligence; lording it over others.""",
"asc_merc/lunarnod":"""Making contacts is easy and pays off.""",
"mc_merc/lunarnod":"""Placed in the forefront in social and business circles.""",
...
#Mars and Lunar 470
"mars_to_natlunarnod":"""Getting along with others; combined efforts pay off.""",
"lunarnod_to_natmars":"""meeting others to get the work done.""",
"sun_mars/lunarnod":"""Good cooperation dynamics; good blending of energies with
others.""",
"moon_mars/lunarnod":"""Emotional attitude toward others shows and leads activity.""",
"merc_mars/lunarnod":"""Plans to collaborate, cooperate, share; promotion through
partnerships; community-minded; salesmanship; publicity.""",
"ven_mars/lunarnod":"""Getting together affectionately, passionately.""",
"jup_mars/lunarnod":"""Successful teamwork; lots of enthusiasm; taking a trip with
someone; planning togetherness for the long term.""",
"sat_mars/lunarnod":"""Something or someone always stepping on one's shadow;
difficulty making the sale; withdrawing because of poor
reception; one's ardor is squashed; looking for more amenable
associations.""",
"ura_mars/lunarnod":"""Organizing others; getting people stirred up; sharing
excitement; sudden events that affect lots ofpeople.""",
"nep_mars/lunarnod":"""Self-absorption within a group; charismatic or off-putting.""",
"plu_mars/lunarnod":"""Others must "get on the train" or get left behind!
"asc_mars/lunarnod":"""Easy camaraderie.""",
mc_mars/lunarnod":"""Excellent teamwork; partnership values important.""",
...
"jup_to_natLunarNode":"""Good relationships, profitable associations; "connections."""",
"natLunarNode_to_natjup":"""Meeting others; making profitable liaisons; "connections."""",
"sun_jup/LunarNode":"""Feeling good about one's self in relation to others; building
confidence to support action.""",
"moon_jup/LunarNode":"""An emotional and enthusiastic projection to others pays off.""",
"merc_jup/LunarNode":"""Thinking about others' welfare; sharing success; appreciating
the complementation ofpartnership.""",
"ven_jup/LunarNode":"""Pleasantness with others; a graceful image; caring.""",
"mars_jup/LunarNode":"""Successful teamwork.""",
"sat_jup/LunarNode":"""Working with others by the rules; getting things perfectly clear;
holding back in strategic reserve; slowing things down for safety;
maybe "missing the boat" through caution.""",
"ura_jup/LunarNode":"""Entertaining image; inventive; enthusiastic; new associations.""",
"nep_jup/LunarNode":"""Lack of clarity about the objectives of being or working
together; sharing the spirit with others but not much else,
especially in the way of grounding.""",
"plu_jup/LunarNode":"""Strong personal projection of sociability; "collecting" wellknown
people.""",
"asc_jup/LunarNode":"""Pleasantness with others.""",
"mc_jup/LunarNode":"""Recognition for one's humanity and agreeableness.""",
...
"ura_to_natlunarnode ":"""Meetings with unusual people pay off; sudden relationships.""",
"lunarnode _to_natura":"""Shared experiences are particularly rewarding.""",
"sun_ura/lunarnode ":"""High tension; a group taking action.""",
"moon_ura/lunarnode ":"""Excitability; a team taking a stand.""",
"merc_ura/lunarnode ":"""Excited thoughts shared with others; impetuousness.""",
"ven_ura/lunarnode ":"""Sudden attachments, romantic or just like-minded: the
camaraderie is what is important.""",
"mars_ura/lunarnode ":"""Tremendous energy and tension; having an axe to grind and
gaining support.""",
"jup_ura/lunarnode ":"""The big opportunity comes to those demanding it.""",
"sat_ura/lunarnode ":"""Difficulties encountered together with others; the acceptance of
controls by "group vote."""",
"nep_ura/lunarnode ":"""Meeting with people off the beaten path.""",
"plu_ura/lunarnode ":"""The strong need to be influential, persuasive; rocking the boat,
and people approving the motion.""",
"asc_ura/lunarnode ":"""Sudden new acquaintances.""",
"mc_ura/lunarnode ":"""Teamwork paying off; professional recognition.""",
...
"nep_to_natlunarnod":"""Possible breakdown of relationships; sense of being out of the
group, or bound together through spiritual sharing.""",
"lunarnode _to_natnep":"""Meeting with others interested in paranormal dimensions.""",
"sun_nep/lunarnod":"""Seeking to establish contacts with others through artistic or
spiritual exchange; or else feeling misunderstood.""",
"moon_nep/lunarnod":"""High sensitivity; feeling ostracized; being misunderstood.""",
"merc_nep/lunarnod":"""Imagination shared with others; expecting too much from
others; being let down by occurrences; undependability.""",
"ven_nep/lunarnod":"""Vagueness about emotional values; suspicions; promiscuity.
"mars_nep/lunarnod":"""Charisma; resourceful adaptation to others.""",
"jup_nep/lunarnod":"""Spiritual bonds with others; religiousness tightens relationships.""",
"ura_nep/lunarnod":"""Emotional hurt through deception, unfaithfulness, duplicity.""",
"sat_nep/lunarnod":"""Self-willed motives disrupt group ideas.""",
"plu_nep/lunarnod":"""Difficulty blending personal perspective with others' views.""",
"asc_nep/lunarnod":"""Appearing strange to others; being duped.""",
"mc_nep/lunarnod":"""Taking a position off the mainstream of life.""",
...
"nep_to_natmc":"""MC Very important time of life: there can be the sense of ego disappearance;
...
"ura_nep/mc":"""The feeling of being wiped out; needing to correct past mistakes
with honest, open, clear statements and plans.""",
"sat_nep/mc":"""Intense impatience; self-righteousness; creativity.""",
"plu_nep/mc":"""The supernatural as a professional focus; strange happenings on
the job or in the home.""",
"nod_nep/mc":""""asc_nep/mc":"""Difficult relationships; peculiarities.""",
...
"lunarnode_to_natasc ":"""Personal relationships.""",
"asc _to_natlunarnode ":"""Personal relationships.""",
"sun_lunarnode/asc":"""Helpful social contacts; gregariousness; an entertaining
personality.""",
"moon_lunarnode/asc":"""Emotional bonds with others; sympathy; caring for others.""",
"merc_lunarnode/asc":"""Entertainment; gossip; exchanging ideas; getting input from
others; news; traveling to meetings.""",
"ven_lunarnode/asc":"""Pleasantness; affectionate associations.""",
"mars_lunarnode/asc":"""Working for the common good; the "doer."""",
"jup_lunarnode/asc":"""Sociability; humanitarianism; congeniality.""",
"ura_lunarnode/asc":"""Prevailing with realism and wisdom; conservatism.""",
"sat_lunarnode/asc":"""All for the avant-garde; unusual associations; upbeat ways of
doing things with other people.""",
"nep_lunarnode/asc":"""Making relationships with others through sensitivities and even
interests in the paranormal; impressionability.""",
"plu_lunarnode/asc":"""Power plays with others for personal advancement.""",
"mc_lunarnode/asc":"""Sense of community.""",
