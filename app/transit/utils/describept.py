...
describe = {
"sun_to_natsun":'Not applicable',
"moon_to_natmoon":'Not applicable',
"merc_to_natmerc":'Not applicable',
"ven_to_natven":'Not applicable',
"mars_to_natmars":'Not applicable',
"jup_to_natjup":'Not applicable',
"sat_to_natsat":'Not applicable',
"ura_to_natura":'Not applicable',
"nep_to_natnep":'Not applicable',
"plu_to_natplu":'Not applicable',
"nod_to_natnod":'Not applicable',

"asc_to_natasc":'Not applicable',
"mc_to_natmc":'Not applicable',
...
"sat_to_natmoon":
"""Sobering times; feelings of enforced controls; possible separation in relationship.""",
...
"sat_to_natmerc":"""Wisdom through duress; maturation through depression; the sense of heavy responsibility.""",
...
indomitable.""",
"plu_to_natven":"""Intensification of love desires; affairs; compulsiveness; wasting emotions.""",
...
"sat_to_natmc":"""Major change in the family or in the profession; possible death concerns within the extended family circle; the father figure; an extremely important time of life development.""",
"mc_to_natsat":"""Focus upon ambition; professional change; significant family development; a major move.""",
"sun_sat/mc":"""Need to fight hard and having the capacity to do so.""",
"moon_sat/mc":"""Renunciation of one thing and the adoption of another to fulfill needs better; an attack on private emotions.""",
...
"ura_to_natnep":
"""Exploring individuation through imagination; through speculation; through creativity; possible use of underhanded means (artfully rationalized) to do the job.""",
"nep_to_natura":
"""Loss of ego focus is possible if socio-professional position is unstable; spiritual world is awakened; amorphous states; irritability.""",
