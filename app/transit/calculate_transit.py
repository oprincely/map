...
def main(btd,btm,bty,transit_day,transit_month,transit_year,asc,mc,prog_moon):
    ...
    def in_transit_move(u, u1, transit, aspect,planet_position,tipe): #n=planet_position
        result =[]
        if u in transit:
