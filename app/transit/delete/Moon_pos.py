...
def planet_pos(day_after_planet_position, birth_day_planet_position,month_day):
    ...
    correction = birth_day_planet_pt + planet_has_moved + time_to_sec(1,17,0) #=> astrodient correection
    ...
    if cal_deg <= 29:
        ...
        planet_position = [(cal_deg - 29), cal_min, (birth_day_planet_position[2] + 1),birth_day_planet_position[3]]
    
    #print('planet_position = ',planet_position)
    
    return planet_position

#print(planet_pos([5, 58, 5], [22, 8, 4],(11,28)))
